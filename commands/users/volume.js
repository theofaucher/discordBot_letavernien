module.exports.run = (client, message, args) => {
	...
	if (args[0] > 10) return message.channel.send('Je préfère que tu gardes tes tympans')
	if (args[0] < 0) return message.channel.send('Tu es bourré(e) ou quoi ? Du son négatif PTDR')
