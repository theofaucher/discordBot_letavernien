...
module.exports.run = async (client, message, args) => {
  ...
  const song = {
    id: songInfo.player_response.videoDetails.video_id,
    title: Util.escapeMarkdown(songInfo.player_response.videoDetails.title),
  ...
  try {
    ...
    message.client.queue.delete(message.guild.id);
    await channel.leave();
    return message.channel.send(`Je ne peux pas rejoindre le salon: ${error}`);
  }
